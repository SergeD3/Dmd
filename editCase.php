...
<body>
  ...
  <div class="drm_main_cont">
    <div class="drm_cont">
      ...
      <form action="editCase_cont.php" method="post">
        ...
        <div class="input-group">
          ...
          <textarea class="form-control" aria-label="With textarea"><?php echo $return["ПОС_комм"]; ?></textarea>
        </div>
        <div class="input-group mt-3">
          <div class="input-group-prepend ml-2 ">
          <span class="input-group-text">Комментарий к аутопсии:</span>
          </div>
          <textarea class="form-control" aria-label="With textarea"><?php echo $return["Коментарий"]; ?></textarea>
          </div>
        </div>
    </div>
  </div>
